...
public partial class MainAppSplashContent : UserControl
{
    ...
    protected override void OnLoaded(RoutedEventArgs e)
    {
        ...
        {
            Dispatcher.UIThread.Post(() => { RunAnimations(); }, DispatcherPriority.Background);
        }
    }
    ...
    private void RunAnimations()
    {
        ...
        grad1.CenterPoint = new Vector3((float)(grad1.Size.X / 2f), (float)(grad1.Size.Y / 2f),
            (float)grad1.CenterPoint.Z);
        ...
        fa.Opacity = 0;
        fa.CenterPoint = new Vector3((float)fa.Size.X / 2f, (float)((fa.Size.Y / 2f) - (fa.Size.Y * 0.1f)),
            (float)fa.CenterPoint.Z);
    ...
    private CompositionAnimationGroup GetGradientBarAnimation(Compositor comp, int step)
    {
        ...
        ani.InsertKeyFrame(1f, Vector3.One, new SplineEasing(0, 0, 0));
        ani.Target = "Scale";
        ...
        opacAni.InsertKeyFrame(1f, 1f, new SplineEasing(0, 0, 0));
    ...
    private CompositionAnimationGroup GetBlockAnimation(Compositor comp, bool bottom)
    {
        ...
        ani.InsertExpressionKeyFrame(1f, "this.FinalValue", new SplineEasing(0, 0, 0));
